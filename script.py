...
while True:
   ...
   if i=="local":
        ...
        def httpddocker():
                      ...
                      os.system("sudo  yum install docker-ce --allowerasing  -y")                     
                      os.system("sudo systemctl start docker")
                      os.system("sudo systemctl enable docker")
                      os.system("sudo systemctl status docker")
                      os.system("sudo semanage permissive -a container_runtime_t")
                      ...
                      os.system("docker exec  {} /usr/sbin/httpd".format(img))
